...
const createAttendanceDto: Record<
  string,
  {
...
export const createAttendanceExamplesForSwagger =
  getExamples(createAttendanceDto);

const createBulkAttendanceDto: Record<
  string,
  {
    attendanceDate: string;
    contextId: string;
...
export const createBulkAttendanceExamplesForSwagger = getExamples(
 ...
 */
const searchAttendanceDto: Record<
  string,
  {
    limit: number;
    page: number;
